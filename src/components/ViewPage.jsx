...
function ViewPage() {
  ...
  return (
    ...
    >
      <div
        className="pt-20 justify-between"
        style={{ width: "100%", height: "100%" }}
      >
        <Filter
          filter={filter}
